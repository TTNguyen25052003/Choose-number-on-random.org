...
(function () {
    ...
    // You can create the the list you want here
    /*Example*/ let happyRandomList = [1, 2, 3, 4, 5]

    function controlRandom() {
        let randomPosition = Math.floor(Math.random() * happyRandomList.length)
        let happyNumber = happyRandomList[randomPosition]
        happyRandomList.splice(randomPosition, 1)
